...
export type AirQualityData = {
    ...
    pm10Grade: string; // 미세먼지(PM10) 24시간 등급
...
export type AirQualityNameAndGrade = {
    khaiGrade: { name: string; gradeNum: string; grade: string; };
    pm25Grade1h: { name: string; gradeNum: string; grade: string; };
    pm10Grade1h: { name: string; gradeNum: string; grade: string; };
    o3Grade: { name: string; gradeNum: string; grade: string; };
    so2Grade: { name: string; gradeNum: string; grade: string; };
    no2Grade: { name: string; gradeNum: string; grade: string; };
    coGrade: { name: string; gradeNum: string; grade: string; };
    [key: string]: { name: string; gradeNum: string; grade: string; };
}
...
export type AirQualityGradeNumber = "1" | "2" | "3" | "4" | "0";
